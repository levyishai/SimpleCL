...
public class Constants {
    ...
    public static final TextComponent
            UPD_MESSAGE_PART1 = new TextComponent("There is a new version of the plugin available! Go to "),
    ...
    public static final String
            BORDER_DISABLED_FAIL = "BorderHopping is disabled but WGRegionEvents is not found!" +
            " got to https://www.spigotmc.org/resources/worldguard-region-events-updated.61490/ to install it",
    ...
    static {
        ...
        Constants.UPD_MESSAGE_PART2.setHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT,
